...
for (feature_num in c(50,100,150,200,300,400,500,1000,1500,2000,3000,4000,5000)) {
	for (fold_num in 1:10) {
		...
		command = sprintf('sbatch --job-name=%s --mem=64G --time=24:00:00 --wrap "./build_random_forest_models_no_tune.R --feature_num %d --fold_number %d"', job_name, feature_num, fold_num)
