...
dir.create(here('results/single_model_rand_features/', 
								sprintf('rand_forest/%dfeat_notune/',args$feature_num)), 
					 showWarnings = F, recursive = T)

full_output_file = here('results/single_model_rand_features/', 
									 sprintf('rand_forest/%dfeat_notune/',args$feature_num),
...
pred_output_file = here('results/single_model_rand_features/', 
									 sprintf('rand_forest/%dfeat_notune_pred/',args$feature_num),
									 sprintf('fold%04d_test.rds',args$CV_fold_ID))

feature_cor = read_rds(here('results/single_model_rand_features/CV_feature_cors/',
