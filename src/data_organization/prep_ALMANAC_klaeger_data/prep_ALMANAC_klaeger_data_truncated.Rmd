---
title: "prep_ALMANAC_klaeger_data_truncated"
...
klaeger_combinations = read_rds(here('results/synergy_pred/ALMANAC_klaeger_synergy_combos_truncated.rds')) %>% 
...
write_csv(ALMANAC_klaeger_data, here('results/ALMANAC_klaeger_data_for_ml_truncated_updated.csv'))
