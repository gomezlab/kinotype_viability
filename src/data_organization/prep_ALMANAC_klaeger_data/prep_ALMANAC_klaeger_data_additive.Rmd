---
title: "prep_ALMANAC_klaeger_data_additive"
...
klaeger_combinations = read_rds(here('results/synergy_pred/ALMANAC_klaeger_synergy_combos_additive.rds')) %>% 
...
write_csv(ALMANAC_klaeger_data, here('results/ALMANAC_klaeger_data_for_ml_additive.csv'))
