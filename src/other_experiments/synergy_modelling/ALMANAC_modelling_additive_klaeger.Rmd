---
title: "ALMANAC modelling with additive klaeger vectors"
...
```{r}
#read in data 
ALMANAC_klaeger_data = read_csv(here('results/ALMANAC_klaeger_data_for_ml_additive.csv'))
...
ggsave(here('figures/ALMANAC_additive_classification_model_results.png'))
```
...
ggsave(here('figures/ALMANAC_additive_regression_model_results.png'))
```