...
```{r}
#check if tuning lasso within xgboost is possible 
ALMANAC_klaeger_CCLE_data = read_csv(here('results/ALMANAC_klaeger_data_for_ml.csv'))
...
write_csv(results, here('results/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
```

```{r}
# fit best model for figure
results = read_csv(here('results/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
...
ggsave(here('figures/misc/ALMANAC_klaeger_best_model_CV.png'))
```