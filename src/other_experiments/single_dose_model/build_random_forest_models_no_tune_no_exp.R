...
dir.create(here('results/single_dose_model/', 
								sprintf('rand_forest_no_exp/%dfeat_notune/',args$feature_num)), 
...
dir.create(here('results/single_dose_model/', 
								sprintf('rand_forest_no_exp/%dfeat_notune_pred/',args$feature_num)), showWarnings = F)

pred_output_file = here('results/single_dose_model/', 
									 sprintf('rand_forest_no_exp/%dfeat_notune_pred/',args$feature_num),
									 sprintf('fold%04d_test.rds',args$CV_fold_ID))
