---
title: "Prep DK Compound Validation Screen Data"
author: "Chinmaya"
date: "`r Sys.Date()`"
...
plate_vals = bind_rows(
	read_csv_plate_data(here('data/DK_compound_screen/HCC_Dark_1.csv'),c("Placeholder","SGC-CK2-1N"),"HCC1806"),
	read_csv_plate_data(here('data/DK_compound_screen/HCC_Dark_2.csv'),c("SGC-CK2-1","SGC-CAMKK2-1N"),"HCC1806"),
	read_csv_plate_data(here('data/DK_compound_screen/HCC_Dark_3.csv'),c("BI00036838","SGC-CAMKK2-1"),"HCC1806"),
	
	read_csv_plate_data(here('data/DK_compound_screen/SUM_Dark_1.csv'),c("Placeholder","SGC-CK2-1N"),"SUM159PT"),
	read_csv_plate_data(here('data/DK_compound_screen/SUM_Dark_2.csv'),c("SGC-CK2-1","SGC-CAMKK2-1N"),"SUM159PT"),
	read_csv_plate_data(here('data/DK_compound_screen/SUM_Dark_3.csv'),c("BI00036838","SGC-CAMKK2-1"),"SUM159PT"),
) %>% filter(compound != "Placeholder")
...
ggsave(here('figures/validation_screen/lum_distribution_DK_compounds.png'))
...
plate_vals_row_norm = plate_vals %>%
	...
	qc_filter() %>%
	write_rds(here('results/validation_results/DK_compound_validation_screen.rds'))
...
ggsave(here('figures/validation_screen/DK_compound_validation_viabilities_row_norm.png'),width=20*0.75,height=15*0.75)
BerginskiRMisc::trimImage(here('figures/validation_screen/DK_compound_validation_viabilities_row_norm.png'))
```