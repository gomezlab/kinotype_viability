...
plate_vals = bind_rows(
	...
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_1.csv'),c("sotrastaurin","ONO-4059 (analog)"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_2.csv'),c("MLN-2480","TAK-733"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_3.csv'),c("GDC-0994","Ro-5126766"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_4.csv'),c("Lestaurtinib","UCN-01"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_5.csv'),c("PF-3758309","RGB-286638"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_6.csv'),c("Pexmetinib", "K-252a"),"HCC-1806")
)
