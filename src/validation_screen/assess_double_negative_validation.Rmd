...
PRISM_predictions <- readRDS(here('results/model_predictions_1500feat.rds')) %>% 
...
ggsave(here('figures/validation_screen/double_negative_validation_vs_pred_or_PRISM.png'),height=3,width=11.75)
