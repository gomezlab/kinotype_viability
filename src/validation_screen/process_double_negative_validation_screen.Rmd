---
title: "Prep double negative Validation Screen Data"
author: "Chinmaya"
date: "`r Sys.Date()`"
...
plate_vals = bind_rows(
	read_csv_plate_data(here('data/PRISM_validation_screen/SKBR3_1.csv'),c("RGB-286638","XL-228"),"SKBR3"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SKBR3_2.csv'),c("JANEX-1","Losmapimod"),"SKBR3"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SKBR3_3.csv'),c("K-252a", "CC-401"),"SKBR3"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SKBR3_4.csv'),c("Ceritinib","ACTB-1003"),"SKBR3"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SUM159_1.csv'),c("RGB-286638","XL-228"),"SUM159"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SUM159_2.csv'),c("JANEX-1","Losmapimod"),"SUM159"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SUM159_3.csv'),c("K-252a", "CC-401"),"SUM159"),
	read_csv_plate_data(here('data/PRISM_validation_screen/SUM159_4.csv'),c("Ceritinib","ACTB-1003"),"SUM159")
)

plate_order = c("RGB-286638","XL-228","JANEX-1","Losmapimod","K-252a", "CC-401", "Ceritinib","ACTB-1003")
...
plate_vals_row_norm = plate_vals %>%
	...
	qc_filter() %>%
	write_rds(here('results/validation_results/double_negative_validation_screen.rds'))
...
ggsave(here('figures/validation_screen/double_negative_validation_viabilities_row_norm.png'),width=20*0.75,height=15*0.75)
BerginskiRMisc::trimImage(here('figures/double_negative_validation_screen/validation_viabilities_row_norm.png'))
```