---
title: "Prep PRISM Replication Screen Data"
author: "Chinmaya"
date: "`r Sys.Date()`"
...
plate_vals = bind_rows(
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_PRISM_1.csv'),c("Dinaciclib","Lestaurtinib"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_PRISM_2.csv'),c("TAK-733","Trametinib"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_PRISM_3.csv'),c("Masitinib","Palbociclib"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_PRISM_4.csv'),c("AT-9283","UCN-01"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_PRISM_5.csv'),c("Gilteritinib","Cobimetinib"),"HCC-1806"),
	read_csv_plate_data(here('data/PRISM_validation_screen/HCC_PRISM_6.csv'),c("KW-2449","MK-2206"),"HCC-1806")
)

plate_order = c("Dinaciclib","Lestaurtinib","TAK-733","Trametinib","Masitinib",
...
ggsave(here('figures/validation_screen/HCC_PRISM_DMSO_boxplots.png'))
```
...
ggsave(here('figures/validation_screen/HCC_PRISM_lum_distribution.png'))
...
plate_vals_row_norm = plate_vals %>%
	...
	qc_filter() %>%
	write_rds(here('results/validation_results/HCC_PRISM_replication_screen.rds'))
...
ggsave(here('figures/validation_screen/PRISM_replication_viabilities_row_norm.png'),width=20*0.75,height=15*0.75)
BerginskiRMisc::trimImage(here('figures/validation_screen/PRISM_replication_viabilities_row_norm.png'))
```