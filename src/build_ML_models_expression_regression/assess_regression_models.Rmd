...
r2_plot = ggplot(model_tuning_results_summary,
	...
	geom_hline(aes(yintercept = default_results$r2_conf.low),alpha=0.25,lty = 2,color='red') +
	# geom_point() +
	geom_errorbar(aes(ymin=r2_conf.low,ymax=r2_conf.high)) +
	theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
...
rmse_plot = ggplot(model_tuning_results_summary,
	...
	geom_hline(aes(yintercept = default_results$rmse_conf.high),alpha=0.25,lty = 2,color='red') +
	# geom_point() +
	geom_errorbar(aes(ymin=rmse_conf.low,ymax=rmse_conf.high)) +
	theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
...
ggsave(here('figures/single_model_expression/rand_forest_500_feat_tree_count.png'),
			 r2_plot + rmse_plot + plot_layout(guides = "collect") & 
			 	theme(legend.position = 'bottom', legend.margin=margin(0,0,0,0), legend.box.margin=margin(-10,-10,-10,-10)),width=4.5,height=2.25)
BerginskiRMisc::trimImage(here('figures/single_model_expression/rand_forest_500_feat_tree_count.png'))
```
