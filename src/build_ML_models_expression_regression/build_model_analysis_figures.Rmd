...
ggsave(here('figures/single_model_expression/top_25_VIP.png'),width=3.5,height=3.75)
...
ggplot(all_importance %>% 
	...
	labs(y='',fill='',x='Feature Importance') +
	BerginskiRMisc::theme_berginski()
ggsave(here('figures/single_model_expression/top_25_exp_VIP.png'),width=3.5,height=3.75)
...
ggplot(all_importance, aes(x=feature_type,y=Importance)) + 
	...
	BerginskiRMisc::theme_berginski()
ggsave(here('figures/single_model_expression/importance_box.png'),width=2,height=4.5)
