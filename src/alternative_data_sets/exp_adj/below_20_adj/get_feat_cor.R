...
dir.create(here('results/exp_adj/below_20_adj'), recursive = T)
...
dir.create(here('results/exp_adj/below_20_adj/CV_feature_cors/'), recursive = T, showWarnings = F)

write_rds(feature_cor,
					here('results/exp_adj/below_20_adj/CV_feature_cors/',sprintf('%04d.rds',args$CV_fold_ID)),
					compress = 'gz')
toc()