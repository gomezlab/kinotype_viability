...
if (file.exists(here('results/single_model_expression_regression_1.2_trunc/CV_split_row_nums.rds'))) {
	...
	write_rds(fold_ids, here('results/single_model_expression_regression_1.2_trunc/CV_split_row_nums.rds'))
}
...
dir.create(here('results/single_model_expression_regression_1.2_trunc'), recursive = T)
...
dir.create(here('results/single_model_expression_regression_1.2_trunc/CV_feature_cors/'), recursive = T, showWarnings = F)

write_rds(feature_cor,
					here('results/single_model_expression_regression_1.2_trunc/CV_feature_cors/',sprintf('%04d.rds',args$CV_fold_ID)),
					compress = 'gz')
toc()