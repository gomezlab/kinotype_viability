...
drug_list = sort(unique(klaeger_wide_filtered$drug))

possible_klaeger_combos = crossing(
	drug_1 = drug_list,
	drug_2 = drug_list,
	concentration_M_d1 = unique(klaeger_wide_filtered$concentration_M),
	concentration_M_d2 = unique(klaeger_wide_filtered$concentration_M)
