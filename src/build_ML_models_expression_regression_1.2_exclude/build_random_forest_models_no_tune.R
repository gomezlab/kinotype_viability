...
dir.create(here('results/single_model_expression_regression_1.2_exclude/', 
								sprintf('rand_forest_%dfeat_notune/',args$feature_num)), showWarnings = F)

full_output_file = here('results/single_model_expression_regression_1.2_exclude/', 
...
pred_output_file = here('results/single_model_expression_regression_1.2_exclude/', 
									 sprintf('rand_forest_%dfeat_notune_pred/',args$feature_num),
									 sprintf('fold%04d_test.rds',args$CV_fold_ID))

feature_cor = read_rds(here('results/single_model_expression_regression_1.2_exclude/CV_feature_cors/',
